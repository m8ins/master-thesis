...
This combination of a highly reliable service and a fully independent container running the app made it easy to set up a server-less infrastructure with high availability.
